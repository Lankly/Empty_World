...
void tile_data_init(){
  ...
  tile_data[TILE_CORRIDOR]= (tile_t) {.id=TILE_CORRIDOR, .deep=false, .passable=true, .display=ACS_CKBOARD | COLOR_PAIR(CP_DARK_GREY_BLACK), .exam_text="It is a hard stone corridor.\n", .hardness=3, .stopme=true};
}
